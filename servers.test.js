describe("SERVER.JS FUNCTION TESTS", function () {
  ...
  describe("updateServerTable tests when there are no bills", function () {
    ...
    it('Passes when two servers exist in the Server Name/ Earnings table in the UI with $0 earnings', function () {
      expect(serverTbody.innerHTML).toContain('<tr id="server1"><td>Ashley</td><td>$0.00</td></tr>');
      expect(serverTbody.innerHTML).toContain('<tr id="server2"><td>Rafaela</td><td>$0.00</td></tr>');
    });
